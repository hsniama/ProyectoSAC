<div class="box box-info padding-1">
    <div class="box-body">
        ...
        {{-- <div class="form-group">
            {{ Form::label('user_id') }}
            {{ Form::text('user_id', $persona->user_id, ['class' => 'form-control' . ($errors->has('user_id') ? ' is-invalid' : ''), 'placeholder' => 'User Id']) }}
            {!! $errors->first('user_id', '<div class="invalid-feedback">:message</div>') !!}
        </div> --}}

        <div class="form-group">
            {{ Form::label('user_id') }}
            {{ Form::select('user_id', $users, $persona->user_id, ['class' => 'form-control' . ($errors->has('user_id') ? ' is-invalid' : ''), 'placeholder' => 'User Id']) }}
            {!! $errors->first('user_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
