            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.specialities.store') }}" role="form" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name"
                                            ...
                                            placeholder="Ingres el nombre de la nueva especialidad" value="{{ old('name', '') }}">
                                        @if ($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach (App\Models\Speciality::ESTADOS as $status)
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input {{ $errors->has('status') ? 'is-invalid' : '' }}" type="radio" name="status" id="estado_{{ $status }}" value="{{ $status }}" @if($status === old('status')) checked @endif>
