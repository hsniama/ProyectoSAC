    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row">
          ...
          {{-- <div class="col-sm-6">
            <h1 class="m-0">Reporte de cantidad de citas por especialidad</h1>
          </div><!-- /.col --> --}}
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-title fs-3 fw-bolder">Reporte de cantidad de citas por especialidad</div>
                        ...
                        <div class="table-responsive">
                            <table id="tablaReporte" class="table table-striped table-bordered zero-configuration text-center">
                                ...
                                <tbody>
                                    @foreach($specialitywithAppointments as $key => $value)
                                        <tr>
