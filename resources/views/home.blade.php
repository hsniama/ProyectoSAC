                    ...
                    <div class="card-body">
                        ...
                        <div class="block">
                          ...
                          @elseif (!Auth::user()->persona->isComplete())
                              <div class="alert alert-danger d-flex align-items-center alert-dismissible fade show" role="alert">
                                  ...
                                  <div class="d-flex flex-column align-items-center">
                                    ...
                                    <div class="mb-3 mt-3 d-flex justify-content-center">                      
                                      <a href="{{ route('perfil.edit', Auth::user()->persona->id) }}" class="btn btn-warning btn-lg text-decoration-none text-black">
                                          Presiona aquí para completar tu perfil.
                                      </a>                                        
                                    </div>
                          ...
                          @elseif (Auth::user()->persona->isComplete() && Auth::user()->hasRole('super-admin'))
                              <div>
                                <p class="fs-4">
                                  <span class="text-bold">¡Hola {{ Auth::user()->persona->nombres }}!</span>, como <span class="text-bold">Super Administrador</span> puedes operar absolutamente todo el sistema.</br>
                                </p>
                              </div>
                          @elseif (Auth::user()->persona->isComplete() && Auth::user()->hasRole('gerente'))
                              <div>
                                <p class="fs-4">
                                  <span class="text-bold">¡Hola {{ Auth::user()->persona->nombres }}!</span>, como <span class="text-bold">Gerente</span> puedes:</br>
                                   <ul class="fs-5">
                          ...
                          @elseif (Auth::user()->persona->isComplete() && Auth::user()->hasRole('admin'))
                              <div>
                                <p class="fs-4">
                                  <span class="text-bold">¡Hola {{ Auth::user()->persona->nombres }}!</span>, como <span class="text-bold">Administrador</span> puedes operar las siguientes funcionalidades del sistema:</br>
                                   <ul class="fs-5">
                                      <li>Modulo RPU</li>
                          ...
                          @elseif (Auth::user()->persona->isComplete() && Auth::user()->hasRole('doctor'))
                              <div>
                                <p class="fs-4">
                                  <span class="text-bold">¡Hola {{ Auth::user()->persona->nombres }}!</span>, como <span class="text-bold">Doctor</span> puedes:</br>
                                   <ul class="fs-5">
                          ...
                          @elseif (Auth::user()->persona->isComplete() && Auth::user()->hasRole('secretaria'))
                              <div>
                                <p class="fs-4">
                                  <span class="text-bold">¡Hola {{ Auth::user()->persona->nombres }}!</span>, como <span class="text-bold">Secretaria</span> puedes:</br>
                                   <ul class="fs-5">
                          ...
                          @elseif (Auth::user()->persona->isComplete() && Auth::user()->hasRole('paciente'))
                              <div>
                                <p class="fs-4">
                                  <span class="text-bold">¡Hola {{ Auth::user()->persona->nombres }}!</span>, puedes agendar o consultar una cita en la parte izquierda.
                                </p>
                              </div>
                          @else
                              <div>
                                <p class="fs-4">
                                  <span class="text-bold">¡Hola {{ Auth::user()->persona->nombres }}!</span>, tienes los siguientes roles:
                                    <ul class="fs-5">
                                      @foreach (Auth::user()->roles as $rol)
                                        <li>
                                          {{ $rol->name }}
