            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @can('persona-create')
                            <div class="mb-3">
                                <a href="{{ route('secretaria.pacientes.create') }}" class="btn btn-success p-2"  data-placement="left">
                        ...
                        <div class="table-responsive">
                            <table id="tablaNormalDataTable" class="table table-striped table-bordered zero-configuration text-center">
                                <thead class="thead">
                                    <tr>
                                        <th>ID</th>                    
										<th>Username</th>
                                ...
                                <tbody>
                                    ...
                                    {{-- @foreach ($pacientes as $paciente) --}}
                                        <tr>
                                            ...
                                            <td>
                                                @can('paciente-show')
                                                <a href="{{ route('secretaria.pacientes.show', $paciente->id) }}"><button class="btn btn-info mb-2 btn-sm"><i class="fa fa-fw fa-eye"></i>Ver</button></a> </br>   
                                                @endcan
                                                {{-- @can('paciente-edit')
