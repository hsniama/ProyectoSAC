    ...
    <div class="container">
      ...
      <div class="col-xl-12">
        ...
        <div class="row mb-5">
            ...
            <div class="col-12">
                <ul class="list-unstyled float-end">
                    <li>
                        <h3 class="text-danger">Sistema de Atención Médica y Control </h3>
                    </li>
        ...
        <div class="row mt-2 mb-5">
            <p>Hola, <span class="font-weight-bold">{{ $nombres . ' ' . $apellidos }}</span> tenga un cordial saludo por
                parte del
        ...
        <div>
            ...
            <p class="text-center">Secretaria: {{ Auth::user()->person->nombres . ' ' . Auth::user()->person->apellidos }}
            </p>
        </div>
