    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1 class="m-0">Datos personales de: {{ $paciente->apellidos . ' ' . $paciente->nombres}}</h1>
          </div><!-- /.col -->
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @can('paciente-list')
                        <div class="mb-3">
                            <a href="{{ route('secretaria.pacientes.index') }}" class="btn btn-danger btn-sm p-2"  data-placement="left">
